...
async function prismaResponseShaper(prismaFn: any, prismaPar: PrismaParam = [], includeDeletedRecords = false) {
  // zJED TODO: Add a string length checker.
  const returnObject: PrismaResponse = { errors: [], data: { deletedAt: null } };
  try {
